...
func main() {
	...
	if !platformIsAro {
		log.Fatal(fmt.Errorf("ARO-RP must be built, run, and tested with '-tags aro' to support github.com/openshift/installer, see https://github.com/openshift/installer/pull/4843/files"))
	}
